...
Public Class Fluid
    ...
    Public iL, iG, ism, ifg, CpL, CpG, rhoL, rhoG, rhom, viscL, viscG, viscm, kL, kG, km, PrL, PrG, Prm, SurfTL, P, sL, sG As Double 'Sat Prop
    ...
    Sub SatProp(ByVal Tsat As Double)
        ...
        sL = Entropy(name, "Tliq", "SI", Tsat) '20170109 add
        sG = Entropy(name, "Tvap", "SI", Tsat) '20170109 add
    End Sub
