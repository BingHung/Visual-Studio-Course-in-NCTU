    ...
    Sub Cap_Ver4()
        ...
        While (Cap.SectionCout < Cap.Section)
            ...
            If Chokedcheck > Cap.Out_s Then
                Console.WriteLine("Choked =>" & Cap.Out_s)
                Exit While
            End If
            ...
            '    'Console.WriteLine("P2 : {0}, P2_Iteration : {1} , T2 : {2}, Count : {3}", Cap.Out_P, P2_Iteration, Cap.Out_Temp, Cap.SectionCout)
            '    Console.WriteLine("h2 : {0} , s2 : {1}", Cap.Out_h, Cap.Out_s)
            '    Exit While
            'End If

            'End While
            TotalLength = TotalLength + TubeLength
            Console.WriteLine("Totallength :  {0} , LengthAdd : {1}  ", TotalLength, TubeLength)
            Console.WriteLine("OutletTemp : {0} , Entropy : {1}", Cap.Out_Temp, Cap.Out_s)
            Console.WriteLine(Cap.SectionCout)
            Console.WriteLine()
